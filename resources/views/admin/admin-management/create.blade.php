    ...
    <form method="POST" action="{{ route('admin.admin-management.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" id="dob" name="dob" value="{{ old('dob') }}" class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-indigo-500 datepicker" autocomplete="off">
