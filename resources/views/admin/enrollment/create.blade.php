...
<div
    ...
    x-data='enrollmentForm({
        selectedCountry: @json((int) old('country', $defaultCountryId)),
        selectedState: @json((int) old('state', $defaultStateId)),
        selectedCity: @json((int) old('city', $defaultCityId)),
        selectedSpecialization: @json((int) old('specialization_id', 0)),
        selectedPlan: @json((int) old('plan', 0)),
        selectedCoverage: @json((int) old('coverage_id', 0)),
        selectedPaymentMode: @json((string) old('payment_mode', '')),
        showPaymentDetails: @json(old('add_payment_details') || old('payment_method') || old('payment_cheque') || old('payment_upi_transaction_id')),
        showServiceAmount: @json(old('service_amount') !== null),
        showTotalAmount: @json(old('total_amount') !== null),
        paymentMethod: @json((string) old('payment_method', '2')),
    })'
    x-init="init()"
>
    ...
    <form method="POST" action="{{ route('admin.enrollment.store') }}" id="enrollmentForm" novalidate>
        @csrf
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="country" id="country" class="form-input @error('country') border-red-400 @enderror"
                        ...
                        @foreach($countries as $id => $name)
                            <option value="{{ $id }}" {{ old('country', $defaultCountryId) == $id ? 'selected' : '' }}>{{ $name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="state" id="state" class="form-input @error('state') border-red-400 @enderror"
                        ...
                        @foreach($states as $sid => $sname)
                            <option value="{{ $sid }}" {{ old('state', $defaultStateId) == $sid ? 'selected' : '' }}>{{ $sname }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="city" id="city" class="form-input @error('city') border-red-400 @enderror"
                        ...
                        @foreach($cities as $cid => $cname)
                            <option value="{{ $cid }}" {{ old('city', $defaultCityId) == $cid ? 'selected' : '' }}>{{ $cname }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="qualification_year[]" id="qualification_year"
                        ...
                        @foreach($years as $yr)
                            <option value="{{ $yr }}" {{ in_array($yr, (array) old('qualification_year', [])) ? 'selected' : '' }}>{{ $yr }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="medical_registration_no" id="medical_registration_no"
                           value="{{ old('medical_registration_no') }}"
                ...
                <div class="form-group">
                    ...
                    <select name="year_of_reg" id="year_of_reg"
                        ...
                        @foreach($years as $yr)
                            <option value="{{ $yr }}" {{ old('year_of_reg') == $yr ? 'selected' : '' }}>{{ $yr }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group lg:col-span-2">
                    ...
                    <textarea name="clinic_address" id="clinic_address" rows="3"
                              ...
                              placeholder="Full clinic / hospital address">{{ old('clinic_address') }}</textarea>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="plan" id="plan"
                        ...
                        <option value="1" {{ old('plan') == 1 ? 'selected' : '' }}>Normal</option>
                        <option value="2" {{ old('plan') == 2 ? 'selected' : '' }}>High Risk</option>
                        <option value="3" {{ old('plan') == 3 ? 'selected' : '' }}>Combo</option>
                    </select>
            ...
            <div class="mt-6 border-t border-slate-200 pt-5">
                <label class="inline-flex cursor-pointer items-center gap-2 text-sm font-medium text-slate-700">
                    <input type="checkbox" name="add_payment_details" id="add_payment_details" value="1"
                           ...
                           {{ old('add_payment_details') ? 'checked' : '' }}
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="form-group lg:col-span-2">
                        ...
                        <div class="flex flex-wrap gap-4 pt-1">
                            ...
                            <label class="inline-flex cursor-pointer items-center gap-2 text-sm">
                                    <input type="radio" name="payment_method" value="2" {{ old('payment_method', '2') == '2' ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600"
                                       @change="paymentMethod = '2'"> Cash
                            </label>
                            <label class="inline-flex cursor-pointer items-center gap-2 text-sm">
                                    <input type="radio" name="payment_method" value="3"
                                        {{ old('payment_method') == '3' ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600"
                        ...
                        <div class="contents">
                            <div class="form-group">
                                ...
                                <input type="text" name="payment_upi_transaction_id" id="payment_upi_transaction_id"
                                       value="{{ old('payment_upi_transaction_id') }}"
