...
@section('page-title', 'Money Receipts')

@section('content')
<div class="mb-6 flex items-center justify-between">
    <div>
        <h2 class="text-2xl font-bold text-gray-900">Money Receipts</h2>
        <p class="text-gray-600 mt-1">Manage payment receipts</p>
    </div>
    ...
    <div class="p-6">
        <div class="flex items-center justify-center py-20">
            <div class="text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Money Receipts</h3>
